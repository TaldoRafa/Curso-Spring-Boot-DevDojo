...
class AnimeServiceTest {
    ...
    void save_ReturnsAnime_WhenSuccessful() {
        ...
        Anime anime = animeService.save(AnimePostRequestBodyCreator.createAnimePostRequestBodyToBeSave());
    ...
    void replace_UpdatesAnime_WhenSuccessful() {
        Assertions.assertThatCode(() -> animeService.replace(AnimePutRequestBodyCreator.createAnimePutRequestBodyToBeSave()))

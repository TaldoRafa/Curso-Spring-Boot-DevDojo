...
public class AnimeControllerIT {
    ...
    private static final DevDojoUser USER = DevDojoUser.builder()
            .name("Dev Dojo")
            .password("{bcrypt}$2a$10$KX/2W.flM2u4R51elPQLXutELzg8JO/YIPFI8Xgvgg/CCrx538JE2")
            .username("devdojo")
    ...
    static class Config {
        ...
        public TestRestTemplate testRestTemplateRoleAdminCreator(@Value("${local.server.port}") int port) {
            RestTemplateBuilder restTemplateBuilder = new RestTemplateBuilder()
                    .rootUri("http://localhost:" + port)
                    .basicAuthentication("rafa", "academy");
    ...
    void save_ReturnsAnime_WhenSuccessful() {
        devDojoUserRepository.save(USER);
        AnimePostRequestBody animePostRequestBody = AnimePostRequestBodyCreator.createAnimePostRequestBodyToBeSave();
    ...
    @Test
    @DisplayName("delete returns 403 wen user is not admin")
